...
Future<void> onConnectToPCSSH() async {
  String result;
  ipAddress=ipAddressTEC.text;
  portSSH=int.parse(portSSHTEC.text);
  userSSH=userSSHTEC.text;
  passwordSSH=passwordSSHTEC.text;
  ...
  try {
    ...
    if (result == "session_connected") result = await client.execute('echo $passwordSSH | sudo -S whoami') ?? 'Null result'; print(result);
